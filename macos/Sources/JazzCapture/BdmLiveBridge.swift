...
/// ``#/session/<id>/bdm-live``) by calling its ``window.__jazzBdmSegment`` hook over
...
final class BdmLiveBridge: ObservableObject {
    ...
    /// Whether the live page has registered its ``__jazzBdmSegment`` hook (it posted ``bdmLiveReady``).
