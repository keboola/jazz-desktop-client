...
final class BdmWorkshopController: NSObject {
    ...
    private func showPanel() {
        ...
        panel.orderFront(nil)  // order front WITHOUT activating jazz (non-activating panel)
    }
    ...
    private func makePanel() -> NSPanel {
        ...
        // takes button clicks WITHOUT activating jazz, so the user keeps clicking through the
