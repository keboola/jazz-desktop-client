...
final class GuidedExecutionLifecycleTests: XCTestCase {
    ...
    func testGuidedReplaySchemaIsPinnedToServerParityDigest() throws {
        ...
        XCTAssertEqual(
            ...
            "9d91aeec047b49c412cb4be0f19590b1c97235eb884846c9933bbd7cbd7da695")
        // Best-effort parity against a local checkout of the server monorepo. The repository is
        // still named `keboola/jasnost` (it was not renamed with the product), so the directory
        // name below deliberately keeps the old spelling.
    ...
    func testProcessExecutionSchemaIsPinnedToServerParityDigest() throws {
        ...
        XCTAssertEqual(
            JazzArchiveDigest.sha256Hex(data),
            "14c8ee2ae52ee09cb6bcdf9ac4ff705e4650abbc3c37bbd4ca88404e4568ee8a")
        // See the note above: the server monorepo checkout is still `keboola/jasnost`.
        let siblingServer = contractRoot().deletingLastPathComponent()
