...
{
    private readonly Func<CancellationToken, Task> drain; private readonly Func<TimeSpan, CancellationToken, Task> delay; private readonly CancellationTokenSource stop = new();
    private int running; private int nudged; private int attempt;
    public ScreenshotDeliveryScheduler(Func<CancellationToken, Task> drain, Func<TimeSpan, CancellationToken, Task>? delay = null) { this.drain = drain; this.delay = delay ?? Task.Delay; }
