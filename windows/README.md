...
objects carry the canonical SHA-256 and byte length as Files tags; the SHA-256 is also GCS object
metadata, and recovery requires both that metadata and the HEAD content length to match the durable
