...
def main() -> int:
    ...
    video_stream, audio_stream, transcript_stream = session["streamIds"]
    ...
    fixture = {
        ...
        "messages": [
            ...
            _artifact(1, 3, video_artifact),
            _artifact(1, 4, audio_artifact),
            _blob_verified(1, video_artifact),
            _commit(1, 5, commit),
            {
                "kind": "ack",
                "epoch": 1,
                "acknowledgedThroughDeliverySequence": 5,
            ...
            _artifact(2, 2, video_artifact),
            _observation(2, 3, late_video_1),
            _observation(2, 4, transcript_0),
            _artifact(2, 5, transcript_artifact),
            ...
            _commit(2, 6, commit),
            {
                "kind": "ack",
                "epoch": 2,
                "acknowledgedThroughDeliverySequence": 6,
                "state": complete_state,
            },
        ],
        "expectedOutcome": {
            "connectionEpochs": 2,
            "observationDeliveries": 7,
            "uniqueObservations": 5,
            "duplicateObservationDeliveries": 2,
