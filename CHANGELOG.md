...
- **Managed capture-at-launch policy.** The client reads a managed policy
  ...
  decision. An explicit user pause still beats a managed policy. See `windows/README.md`'s
